...
requires_pypfopt = pytest.mark.skipif(not pypfopt_available, reason="pypfopt not installed")
requires_riskfolio = pytest.mark.skipif(not riskfolio_available, reason="riskfolio not installed")
requires_universal = pytest.mark.skipif(not universal_available, reason="universal not installed")
