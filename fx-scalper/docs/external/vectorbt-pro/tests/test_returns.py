...
requires_qs = pytest.mark.skipif(not qs_available, reason="quantstats not installed")
...
class TestAccessors:
    def test_invalid_dtype(self):
        with pytest.raises(AttributeError, match="Can only use \\.returns accessor with numeric data"):
            pd.Series(["a", "b"]).vbt.returns
