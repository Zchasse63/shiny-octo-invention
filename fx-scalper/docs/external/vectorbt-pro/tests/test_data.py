...
lmdbm_available = True
try:
    import lmdbm
except:
    lmdbm_available = False
...
requires_arcticdb = pytest.mark.skipif(not arcticdb_available, reason="arcticdb not installed")
requires_talib = pytest.mark.skipif(not talib_available, reason="talib not installed")
requires_pandas_ta = pytest.mark.skipif(not pandas_ta_available, reason="pandas_ta not installed")
requires_tables = pytest.mark.skipif(not tables_available, reason="tables not installed")
requires_pyarrow = pytest.mark.skipif(not pyarrow_available, reason="pyarrow not installed")
requires_sqlalchemy = pytest.mark.skipif(not sqlalchemy_available, reason="sqlalchemy not installed")
requires_duckdb = pytest.mark.skipif(not duckdb_available, reason="duckdb not installed")
requires_lmdbm = pytest.mark.skipif(not lmdbm_available, reason="lmdbm not installed")
