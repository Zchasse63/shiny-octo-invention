...
if TYPE_CHECKING:
    ...
    from vectorbtpro.knowledge.reranking import Reranker
...
# Scalars
Scalar = Union[int, float, bool, complex, str, object, np.generic]
Number = Union[int, float, bool, complex, np.number]
...
RerankerLike = Union[None, str, MaybeType[Reranker]]
ChatMessage = Any
