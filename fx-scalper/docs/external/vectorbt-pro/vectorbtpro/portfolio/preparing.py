...
class BasePFPreparer(BasePreparer):
    ...
    @cachedproperty
    def pre__multiplier(self) -> tp.ArrayLike:
        """Argument `multiplier` before broadcasting.

        Returns:
            ArrayLike: Contract multiplier before broadcasting.
        """
    ...
    @cachedproperty
    def multiplier(self) -> tp.Array1d:
        """Contract multiplier array aligned with portfolio configuration.

        Returns:
            Array1d: Aligned contract multiplier values.
        """
        return self.align_pc_arr(
            self.pre__multiplier,
            check_dtype=np.number,
            cast_to_dtype=float_,
            arg_name="multiplier",
        )
...
class FOFPreparer(BasePFPreparer):
    ...
    def segment_mask(self) -> tp.ArrayLike:
        ...
        checks.assert_subdtype(segment_mask, bool_, arg_name="segment_mask")
        return segment_mask
