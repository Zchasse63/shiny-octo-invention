...
class SignalsAccessor(GenericAccessor):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            raise AttributeError(f"Can only use .signals accessor with boolean data: {exc}") from exc
    ...
    def empty(cls, *args, fill_value: bool = False, **kwargs) -> tp.SeriesFrame:
        ...
        """
        return GenericAccessor.empty(*args, fill_value=fill_value, dtype=bool_, **kwargs)
    ...
    def empty_like(cls, *args, fill_value: bool = False, **kwargs) -> tp.SeriesFrame:
        ...
        """
        return GenericAccessor.empty_like(*args, fill_value=fill_value, dtype=bool_, **kwargs)
    ...
    def plot_as_markers(
        ...
        **kwargs,
        ...
        if y is None:
            ...
            obj = obj.fillna(False).astype(bool_)
            if y.name is None:
                y = y.rename("Y")
